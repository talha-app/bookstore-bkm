...
public class OrderServiceTest {
    ...
    {
        List<OrderDTO> orderDTOs = (List<OrderDTO>) orderService.listOrders(customer).getBody();
    ...
    private CreateOrderRequestDTO prepareCreateOrderRequestDTO()
    {
        ...
        createOrderRequestDTO.setBookIds(new ArrayList<Long>(Arrays.asList(1L, 2L, 3L)));
